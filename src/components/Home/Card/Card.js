...
//                                 <figure>
//                                     <img className="mb-2 rounded" style={{ width: '15%' }} src={ColorMe} alt="" />
//                                 </figure>
//                                 <h3>ColorMe | Wall Painting Service Provider</h3>
...
//                         </div>
//                         <div className="col-lg-4 col-md-6 mb-4">
//                             <div style={{ background: '#172A45', height: '300px' }} className="p-3 img-animation shadow rounded text-justify ">
//                                 <figure>
//                                     <img className="mb-2 rounded" style={{ width: '15%' }} src={halalshop} alt="" />
//                                 </figure>
//                                 <h3>Halal Valley Shop | E-Commerce Website</h3>
...
//                         <div className="col-lg-4 col-md-6 mb-4">
//                             <div style={{ background: '#172A45', height: '520px' }} className="p-3 img-animation text-justify shadow rounded">
//                                 <figure><img className="mb-2 rounded" style={{ width: '15%' }} src={teslaRider} alt="" /></figure>
//                                 <h3>Tesla Rider | Ride Sharing Web application</h3>
